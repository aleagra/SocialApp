...
const Aside = () => {
  ...
  return (
    <>
      <div className="flex-col relative z-10 flex h-screen max-lg:hidden shadow-md dark:text-white bg-white dark:bg-[#0a0a13]">
        <div className="flex  px-12 max-2xl:px-4 max-lg:px-0 py-12 w-full items-center">

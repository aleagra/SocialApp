...
export function HomeCenter() {
  ...
  return (
    ...
    <>
      <div className=" max-sm:mx-0 max-sm:px-0 flex my-[4rem] max-md:mt-[2rem] max-md:mb-[7rem] lg:ml-[25%] md:ml-[12%] lg:mr-[32%] md:mr-[12%] max-md:mx-16  w-full flex-col max-md:w-[100%] items-center ">
        <UserPost />
